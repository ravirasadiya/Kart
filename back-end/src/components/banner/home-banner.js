...
export class HomeBanner extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>
                <Breadcrumb title="Home Banner" parent="Bannner" />
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <div className="btn-popup pull-right">
                                        ...
                                        <Link type="button" className="btn btn-primary" to="/banner/add-banner" data-toggle="modal" data-original-title="test" data-target="#exampleModal">Add Banner</Link>
